...
Public Class frmReview2
    ...
    Private Sub frmReview_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        '''''''''''''''''''''''''''''
        fn2.isClicked_ItemNotesBnt = False
        fn2.isClicked_NoItemNotesBnt = False
        fn2.isClicked_UnAnsweredBtn = False
        fn2.isClicked_AnsweredBtn = False
        fn2.isClicked_IncorrectBtn = False
        fn2.isClicked_CorrectBtn = False
        fn2.isClicked_MarkedBtn = False
        fn2.isClicked_UnMarkedBtn = False
        '''''''''''''''''''''''''''''
        ...
        For i = 0 To frmMainE.selectedQuestionNum - 1
            ...
            'lblQues(i).Font = New Font("Microsoft Sans Serif", 14.25!, CType((FontStyle.Bold Or FontStyle.Underline), FontStyle), System.Drawing.GraphicsUnit.Point, CType(0, Byte))
            ...
            lblQID(i).Text = i + 1 & ")"
            lblQID(i).Font = New Font("Microsoft Sans Serif", 14.25!, FontStyle.Bold, GraphicsUnit.Point, CType(0, Byte))
    ...
    Private Sub btnItemNotes_Click(sender As Object, e As EventArgs) Handles btnItemNotes.Click
        For i = 0 To frmMainE.selectedQuestionNum - 1
            If dbData(randomArray(i)).note <> "" Then
                fn2.isClicked_ItemNotesBnt = True
                fn2.Text = "REVIEW MODE - REVIEWING ITEMS W/NOTES"
                frmNet2.currQueNo = i
                fn2.DisplayData(i)
                Me.Close()
                Exit For
    ...
    Private Sub btnItemNoNotes_Click(sender As Object, e As EventArgs) Handles btnItemNoNotes.Click
        For i = 0 To frmMainE.selectedQuestionNum - 1
            If dbData(randomArray(i)).note = "" Then
                fn2.isClicked_NoItemNotesBnt = True
                fn2.Text = "REVIEW MODE - REVIEWING ITEMS W/OUT NOTES"
                frmNet2.currQueNo = i
                fn2.DisplayData(i)
                Me.Close()
                Exit For
    ...
    Private Sub BtnUnAnswered_Click(sender As Object, e As EventArgs) Handles BtnUnAnswered.Click
        For i = 0 To frmMainE.selectedQuestionNum - 1
            If dbData(randomArray(i)).answered = "No" Then
                fn2.isClicked_UnAnsweredBtn = True
                fn2.Text = "REVIEW MODE - REVIEWING UNANSWERED ITEMS"
                frmNet2.currQueNo = i
                fn2.DisplayData(i)
                Me.Close()
                Exit For
    ...
    Private Sub BtnAnswered_Click(sender As Object, e As EventArgs) Handles BtnAnswered.Click
        For i = 0 To frmMainE.selectedQuestionNum - 1
            If dbData(randomArray(i)).answered = "Yes" Then
                fn2.isClicked_AnsweredBtn = True
                fn2.Text = "REVIEW MODE - REVIEWING ANSWERED ITEMS"
                frmNet2.currQueNo = i
                fn2.DisplayData(i)
                Me.Close()
                Exit For
    ...
    Private Sub btnIncorrect_Click(sender As Object, e As EventArgs) Handles btnIncorrect.Click
        For i = 0 To frmMainE.selectedQuestionNum - 1
            If dbData(randomArray(i)).correct = "incorrect" Then
                fn2.isClicked_IncorrectBtn = True
                fn2.Text = "REVIEW MODE - REVIEWING INCORRECT ITEMS"
                frmNet2.currQueNo = i
                fn2.DisplayData(i)
                Me.Close()
                Exit For
    ...
    Private Sub btnCorrect_Click(sender As Object, e As EventArgs) Handles btnCorrect.Click
        For i = 0 To frmMainE.selectedQuestionNum - 1
            If dbData(randomArray(i)).correct = "correct" Then
                fn2.isClicked_CorrectBtn = True
                fn2.Text = "REVIEW MODE - REVIEWING CORRECT ITEMS"
                frmNet2.currQueNo = i
                fn2.DisplayData(i)
                Me.Close()
                Exit For
    ...
    Private Sub btnMarked_Click(sender As Object, e As EventArgs) Handles btnMarked.Click
        For i = 0 To frmMainE.selectedQuestionNum - 1
            If dbData(randomArray(i)).marked = True Then
                fn2.isClicked_MarkedBtn = True
                fn2.Text = "REVIEW MODE - REVIEWING MARKED ITEMS"
                frmNet2.currQueNo = i
                fn2.DisplayData(i)
                Me.Close()
                Exit For
    ...
    Private Sub btnUnMarked_Click(sender As Object, e As EventArgs) Handles btnUnMarked.Click
        For i = 0 To frmMainE.selectedQuestionNum - 1
            If dbData(randomArray(i)).marked = False Then
                fn2.isClicked_UnMarkedBtn = True
                fn2.Text = "REVIEW MODE - REVIEWING UNMARKED ITEMS"
                frmNet2.currQueNo = i
                fn2.DisplayData(i)
                Me.Close()
                Exit For
